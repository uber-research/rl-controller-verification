...
class QuadcopterEnv4(GymEnvBase):
    """Gym Env
...
"""
    ...
    def __init__(self, pid_gains=[3000., 300., 2000.]):
        ...
        self.init(env_id=4, used_states = ['e_p','e_q','e_r'], instance_index=0, quadcopter=None, continuous=False)
    ...
    def random_query(self):
        ...
        self._query_memory['rate_queries'].append(self._query)
